  ...
  describe "callbacks" do
    context "after_create" do
      before do
        ...
        @membership.should_receive(:destroy_member_cache)
      end
      it "should destroy_member_cache" do
        @membership.save
      end
    end
    ...
    context "after_destroy" do
      before do
        Membership.add_users_to_groups([Factory(:user)], [@group], :is_owner => true)  # must add a new owner to destroy
        @membership.should_receive(:destroy_member_cache)
      end
      it "should destroy_member_cache" do
        @membership.destroy

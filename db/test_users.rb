User.transaction do
  ...
  (user_steph, user_bgadoury, user_brianb, user_user) = User.create([
               {:email => 'steph@endpoint.com', :password => 'berkman', :password_confirmation => 'berkman', :name => 'Steph' },
  ...
  Membership.add_users_to_groups([user_bgadoury, user_user], [g1])

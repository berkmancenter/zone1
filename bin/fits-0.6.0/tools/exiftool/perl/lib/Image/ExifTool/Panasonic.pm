...
%Image::ExifTool::Panasonic::MPF = (
    GROUPS => { 0 => 'MPF', 1 => 'IFD0', 2 => 'Image'},
    NOTES => 'These tags are found in the MPF APP2 segment of Panasonic JPEG images.',
    0xb000 => 'MPFVersion', #(undef)
    # 0xb001 => int32u[1]
    0xb002 => {
        Name => 'Panasonic_MF_0xb001',
        Unknown => 1,
        # format is undef[32]
        PrintConv => '$_=unpack("H*",$val);s/(....)/$1 /g;$_',
    },
);
